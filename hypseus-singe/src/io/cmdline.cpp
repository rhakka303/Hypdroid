...
bool parse_cmd_line(int argc, char **argv)
{
    ...
    if (parse_subsystems() && parse_romdir() && parse_ramdir() && parse_homedir() &&
        ...
        for (;;) {
            ...
            // Hypdroid "Swap Audio Drivers" App Setting (#195): handled in
            // main() before SDL_Init (SDL picks its audio backend there,
            // ahead of this parser). Accept it here so it isn't rejected as
            // unknown.
            else if (strcasecmp(s, "-aaudio") == 0) {
